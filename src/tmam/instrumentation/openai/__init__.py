...
from tmam.instrumentation.openai.openai import chat_completions, embedding, responses
from tmam.instrumentation.openai.openai import image_generate, image_variatons, audio_create
from tmam.instrumentation.openai.async_openai import async_chat_completions, async_embedding
from tmam.instrumentation.openai.async_openai import async_image_generate, async_image_variatons
from tmam.instrumentation.openai.async_openai import async_audio_create, async_responses
