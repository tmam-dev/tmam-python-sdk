...
from tmam.instrumentation.cohere.cohere import chat, chat_stream, embed
from tmam.instrumentation.cohere.async_cohere import async_chat, async_chat_stream, async_embed
